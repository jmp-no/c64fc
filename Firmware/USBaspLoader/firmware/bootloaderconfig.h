...
/* ---------------------------- C64FC    Config ---------------------------- */
/* This section if cor custom config needed for the C64FC card */
#define USB_CFG_IOPORTNAME      D
#define USB_CFG_INTPORT_BIT     2     // Does also set DPLUS_BIT
...
/*  Cant get software enabled bootloader to work... 
 *  Makeing a hotfix
 */
//    if (MCUCSR == 0 || MCUCSR & (1<<EXTRF)) {
//      MCUCSR = 0;
//      stuckInBootloader = 1;
//    }
}
...
/* Cant get code over to work... dono why and i cant debug it... :/ 
 * Added this to make it stay in bootloader on application or external reset
 */
  //if (stuckInBootloader) return true;
